...
export class Application {
    ...
    async start(): Promise<null> {
        if (!this._server) {
            ...
            router.post('/flavours/:id', (req, res, next) => container.resolve(FlavourController).new(req, res, next));
            router.delete('/flavours/:id', (req, res, next) => container.resolve(FlavourController).delete(req, res, next));
